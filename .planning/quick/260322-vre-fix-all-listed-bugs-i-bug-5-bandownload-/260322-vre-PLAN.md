...
# Plan: Fix listed code bugs in `aereo-search-aws-goes`

## Task 1: Fix Core Bugs in `core.py`
**Files**: `components/aereo/search_aws_goes/core.py`
**Action**:
...
**Files**: `test/components/aereo/search_aws_goes/test_core.py`
**Action**:
...
**Action**:
- Run `pytest test/components/aereo/search_aws_goes/test_core.py` to ensure all tests still pass with the new changes.
