...
## Accomplishments
- Fixed typo in docstring: replace `bandownload_aria2d` with `band` in `aereo-search-aws-goes/core.py`.
...
## Affected Files
- `components/aereo/search_aws_goes/core.py`
- `test/components/aereo/search_aws_goes/test_core.py`
